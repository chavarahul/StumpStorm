...
const About = () => {
  return (
    <section className="min-h-[50vh] w-full py-[4.5vw] lg:mt-20 mt-6 max-lg:flex-col px-10 max-sm:px-4 flex items-center  justify-between relative z-10" id='about'>
      <h1 className="text-[4.4vw] xl:text-[2.7vw] max-lg:mt-10 max-lg:w-full w-[60%] max-lg:order-2 max-lg:leading-[7vw] leading-[4vw] text-black font-semibold textColorChange max-md:text-center" >
