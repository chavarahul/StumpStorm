...
const EventPage = () => {
  ...
  return (
    <div className="min-h-[80vh] py-8 text-black mt-10 max-md:px-5">
      <h1 className="text-4xl font-semibold text-center mb-8 max-md:mb-20">Upcoming Events</h1>
      <div className="flex flex-wrap justify-evenly gap-8  mt-10 max-lg:px-4" ref={eventRef}>
        {events.map((event, index) => (
          <div key={index} className="border-t-[2px] z-10  border-black topUp py-4 h-[30rem] max-lg:h-[38rem] w-full sm:w-[calc(50%-1rem)] lg:w-[calc(25%-1rem)] cardHover">
